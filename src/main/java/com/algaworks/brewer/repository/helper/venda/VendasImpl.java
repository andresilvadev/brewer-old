...
public class VendasImpl implements VendasQueries {
	...
	public BigDecimal valorTotalNoAno() {
		// Foi colocado um BigDecimal com Optional por que se não encontrar nada na consulta sera mostrado zero nas vendas do ano
		// Consulta com JPQL (Query baseada nas propriedades da entidade) e não SQL
		// :ano e :status é o parametro passado na consulta
